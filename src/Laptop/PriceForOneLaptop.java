...
public class PriceForOneLaptop {
    ...
    /*
        ...
        Bu yöntemin Calculation class taki tüm yöntemleri çağırması ve price alması ve total Amount return etmesi gerekir.
     */
     ...
     */
     ...
     /*
        Verilen  method  getDiscount

        Parameter iki tane int (amount , discount)
